...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="action  divaction">
		...
		<div class="pages">
			<s:form action="addBiz_Claim.action" name="claimForm" method="POST">
			...
			<input type="hidden" id="rowNumber" name="rowNumber" value="<s:property value="rowNumber"/>"/>
				<table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
					<tr>
						...
						<td>*填报时间：</td>
						<%--保存在session或者request中才用#session.date如果只是在那边的action中get方法了，直接用那边的属性--%>
						<td><s:date name="date"  format="yyyy-MM-dd"/></td>
					</tr>
					<tr>
						<td>*总金额：￥</td>
						<td><input type="text" id="totalAccount" name="biz_claim.totalAccount" value=""/></td>
						<td>*状态：</td>
						<td><input type="text" id="status" name="biz_claim.status" value="新创建"
				...
				<table>
					<tr>
						<td>*事由：</td>
						<td colspan="3"><textarea rows="5" cols="66" name="biz_claim.event"
										id="event"></textarea>
						</td>
					</tr>
