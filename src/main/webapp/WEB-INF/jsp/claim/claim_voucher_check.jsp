...
<body>
    <div class="action  divaction">
   		...
   		<div class="pages">
        	<!--增加报销单 区域 开始-->
                <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
                  ...
                  <tr>
                    <td>总金额：<s:property value="biz_claim.totalAccount"/></td>
      ...
      <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
      	<s:iterator value="biz_claim.biz_checkResultList" id="checkResult" status="s">
         <tr>
           <td width="27%"><s:property value="#checkResult.check_employee.name" />(<s:property value="#checkResult.check_employee.sys_position.nameCn" />)</td>
    ...
    <s:form action="checkResult.action" name="checkResultForm">
    <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
		<tr>
			<td>
				审批意见：
		...
		<tr>
			<td>
				<textarea name="checkResult.comm" id="textarea" cols="45"
					rows="5"></textarea>
			</td>
		</tr>
		 <!--表单提交行-->
		 <tr>
			<td colspan="3" class="submit">
				...
				<%--<s:hidden id="claimId" name="checkResult.claimId" value="%{biz_claim.id}"/>--%>
                <s:hidden id="claim" name="checkResult.biz_claim.id" value="%{biz_claim.id}"/>
                <s:hidden id="claimAccount" name="checkResult.biz_claim.totalAccount" value="%{biz_claim.totalAccount}"/>
				<s:hidden id="result" name="checkResult.result" value=""/>
				<s:if test='#session.employee.sys_position.nameCn != "财务"'>
