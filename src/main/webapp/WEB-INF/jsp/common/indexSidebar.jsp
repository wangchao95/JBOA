...
<div class="nav" id="nav">
	<div class="t"></div>
   		<dl class="open">
	           ...
	           <dd><a href="toSearchClaim.action">查看报销单</a></dd>
	           <s:if test='#session.employee.sys_position.nameCn == "员工"'>
	           <dd><a href="toBiz_Claim.action">添加报销单</a></dd>
	           </s:if>
	       </dl>
       <dl>
       		<dt onclick="this.parentNode.className=this.parentNode.className=='open'?'':'open';">请假管理</dt>
	           <dd><a href="toSearchLeave.action">查看请假</a></dd>
	           <s:if test='#session.employee.sys_position.nameCn == "员工"'>
		       <dd><a href="toSaveLeave.action">申请请假</a></dd>
		       </s:if>
       </dl>
       <s:if test='#session.employee.sys_position.nameCn == "部门经理"'>
       <dl>
       ...
       <s:if test='#session.employee.sys_position.nameCn == "总经理" ||#session.employee.sys_position.nameCn == "财务"'>
       <dl>
       		<dt onclick="this.parentNode.className=this.parentNode.className=='open'?'':'open';">统计报表</dt>
