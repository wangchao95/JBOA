...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/commonCalim.js">
</script>

<div class="action  divaction">
	<div class="t">月度统计列表</div>
	<div class="pages">
	     <s:form action="claimVoucherStatistics_getDeptStatisticsByMonth.action" name="queryForm">
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0" class="list items">
	      ...
	      <s:iterator value="pageSupport.items" id="claimVoucherStatistics" begin="0" status="s">
	      <tr>
