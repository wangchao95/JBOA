...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="action divaction">
		...
		<div class="pages">
	<!--请假申请 区域 开始-->
	<s:form action="saveLeave.action" method="POST" name="leaveForm">
     <table class="leave">
       <tr>
         <td class="width1"><label for="name">姓名：</label></td>
         <td class="width2"><s:textfield name="name" readonly="true" value="%{#session.employee.name}" cssClass="nwinput" /></td>
       ...
       <tr>
         ...
         <td colspan="3">
          ...
          <p class="leave">
           <label>下一审批人：</label>
           <select name="leave.next_Deal_Sn" class="nwselect" >
             <option value="<s:property value="sys_employee.sn"/>"><s:property value="sys_employee.name"/></option>
           </select>
          </p>
          <p class="marg">
           <input name="button" type="button"  value="提交流程" class="submit_01" onClick="submitLeave()"/>
           <input name="" type="button"  value="取消"  onclick="window.history.go(-1)" class="submit_01"/>
          </p>
     	</div>
     	</s:form>
     <!--请假申请 区域 结束-->
