		...
		<div class="action  divaction">
			...
			<div class="pages">
				...
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td width="36%">
							姓名：<s:property value="leave.sys_employee.name"/>
						</td>
						<td width="64%">
							部门：<s:property value="leave.sys_employee.sys_department.name"/>
						</td>
					</tr>
					<tr>
						<td>
				...
				<s:form action="checkLeave.action" name="leaveForm">
					<input type="hidden" name="leave.sys_employee.sn" value="${leave.sys_employee.sn}"/>
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					class="addform-base">
					<tr>
						<td>
